...
{
    public class FreakFiresCopy : CustomUnlockCard
    {
        public override string UniqueNameID => "freakFiresCopy";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => UnlockHelpers.CopyInfo(UnlockReferences.TrickConstantFires);
    }
}
